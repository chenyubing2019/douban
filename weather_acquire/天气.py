...
mail_host = "smtp.exmail.qq.com"  #腾讯企业邮箱服务器
mail_user = "chenyubing@chenyubing.vip"  # 用户名
mail_pass = "mSo9DRiSxPUdXaHJ"  # 口令
#mail_pass = "vcnpthnckxosjebf"

sender = 'chenyubing@chenyubing.vip'
receivers = ['459012403@qq.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
